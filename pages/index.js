  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="description"
          content="A DAO dedicated to normalizing Mental-Health Care and providing Resources as a Public Good"
        />
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <p className={styles.description}>
            We are building a DAO dedicated to normalizing Mental-Health Care
            and providing Resources as a{" "}
            <code className={styles.code}>Public Good</code>
          </p>
          ...
          >
            <h2>Telegram &rarr;</h2>
            <p>Receive updates from the Wellness DAO.</p>
          </a>
      ...
      <footer className={styles.footer}>
        <a href="https://jcstein.dev" target="_blank" rel="noopener noreferrer">
          Powered by{" "}
